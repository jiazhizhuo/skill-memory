...
# LLM: MiniMax-M2.5 或 MiniMax-M2.7
MINIMAX_LLM_BASE_URL = _env("MINIMAX_LLM_BASE_URL", "https://api.minimaxi.com/v1")
MINIMAX_LLM_MODEL = _env("MINIMAX_LLM_MODEL", "MiniMax-M2.5")
# Embedding: 需要用独立的 embedding API token
MINIMAX_EMBEDDING_BASE_URL = _env("MINIMAX_EMBEDDING_BASE_URL", "https://api.minimaxi.com/v1")
